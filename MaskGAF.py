...
class RelationGraphConvolution(nn.Module):
    ...
    def __init__(self, in_features, out_features, edge_dim=9, aggregate='sum', dropout=0., use_relu=True, bias=False):
        '''
...
class RGCN(nn.Module):
    def __init__(self, nfeat, nhid=128, nout=128, edge_dim=9, num_layers=3, dropout=0., normalization=False):
        '''
